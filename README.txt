...
Demo Awesome - The Data Importer is a plugin designed specially for [Theme4Press](https://theme4press.com/) themes users to help start building outstanding websites with one click. The unique predefined demos will set your website with modern theme settings, demo posts and pages, widgets, menus and much more. Create blogs, magazines or e-shops within few minutes. Awesome!
...
2. Live preview of a demo directly in the admin page
3. The pop up will inform about required plugins for particular demo
4. Once import finished, you can start to customize
