...
/**
 * Demo_Awesome_Customizer_Importer Class.
 */
if ( ! class_exists( 'Demo_Awesome_Customizer_Importer' ) ) {
	class Demo_Awesome_Customizer_Importer {
		...
		public static function import( $import_file, $data_demo ) {
			...
			// Import Images.
			if ( apply_filters( 'demo_awesome_customizer_import_images', true ) ) {
			...
			if ( isset( $data['options'] ) ) {
				...
				include_once dirname( __FILE__ ) . '/class-extends-customize-demo-importer-setting.php';

				foreach ( $data['options'] as $option_key => $option_value ) {
					$option = new Demo_Awesome_Customize_Demo_Importer_Setting( $wp_customize, $option_key, array(
						'default'    => '',
						'type'       => 'option',
