...
class Demo_Awesome {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Demo_Awesome_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Demo_Awesome_Loader. Orchestrates the hooks of the plugin.
	 * - Demo_Awesome_i18n. Defines internationalization functionality.
	 * - Demo_Awesome_Admin. Defines all hooks for the admin area.
	 * - Demo_Awesome_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'inc/admin/class-admin.php';
	 ...
	 *
	 * Uses the Demo_Awesome_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Demo_Awesome_Loader    Orchestrates the hooks of the plugin.
	 */
